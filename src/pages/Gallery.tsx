            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
              {paginatedFiltered.map((photo: any, i: number) => {
                ...
                return (
                  ...
                  >
                    {photo.image_url ? (
                      <img src={photo.image_url} alt={photo.alt || ""} data-db-image="1" loading="lazy" className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-110" />
                    ) : (
