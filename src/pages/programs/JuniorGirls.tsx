...
const JuniorGirls = () => {
  return (
    <Layout>
      <PageHeader title="Paradise Hitters" subtitle="Girls' Junior Volleyball Club" />
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-12 flex h-64 items-center justify-center rounded-lg bg-gradient-to-br from-accent/20 to-primary/20">
          <div className="text-center">
            ...
            <p className="mt-2 text-muted-foreground">Paradise Hitters — Team Action Photo</p>
          </div>
        </div>
          ...
          <div className="space-y-8 lg:col-span-2">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                The Paradise Hitters is BVA's competitive girls' volleyball program, developing young female 
                athletes ages 12-18 in both indoor and beach volleyball. The program provides structured 
                training, competitive league play, and opportunities to represent Bermuda in regional and 
                international competitions. Players develop technical skills, tactical awareness, physical 
                fitness, and leadership qualities.
              </p>
            </section>
                ...
                <Card>
                  <CardContent className="flex items-start gap-3 p-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Open to girls ages 12-18. Multiple age divisions for appropriate competition levels.</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
                {["Practice Session", "Tournament Play", "Team Building", "Beach Training", "Awards Ceremony", "Group Photo"].map((label) => (
                  <div key={label} className="flex aspect-square items-center justify-center rounded-lg bg-gradient-to-br from-accent/10 to-primary/10 text-center">
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Partial scholarships of $500 available for the first term.
                </p>
